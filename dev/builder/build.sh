...
java -jar ckbuilder/$CKBUILDER_VERSION/ckbuilder.jar --build ../../ release --leave-css-unminified --leave-js-unminified --version="4.4.0 DEV" --build-config build-config.js --overwrite "$@"
